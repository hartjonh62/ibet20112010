        ...
        public clsBalance getByAccId(Int64 accid)
        {
            try
            {
                ...
                if (dr.Read())
                {
                    ...
                    {
                        obj.Active = Convert.ToInt32(dr["Active"]);
                    }
                    if (dr["Close"] != DBNull.Value)
                    {
                        obj.Close = Convert.ToInt32(dr["Close"]);
                    }
                    if (dr["Suspended"] != DBNull.Value)
                    {
                        obj.Suspended = Convert.ToInt32(dr["Suspended"]);
                    }
                    if (dr["MemberCredit"] != DBNull.Value)
                    {
                        obj.MemberCredit = Convert.ToDecimal(dr["MemberCredit"]);
                    }
                }
                return obj;
            }
