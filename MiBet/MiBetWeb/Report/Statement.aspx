        ...
        <div id="header_main">
            <div class="divBoxRight">
                <input type="image" id="exporttoexcel" name="exporttoexcel" alt="Export to Excel"
                    ...
                    class="hand" /></div>
            <asp:Label ID="lblTitle" runat="server" Text="Statement"></asp:Label>
        </div>
            ...
            <tr>
                <td>
                    <div id="divContent">
                        ...
                        <table class="tblRpt boldrow r" width="650" border="0" cellpadding="0" cellspacing="1"
                            id="tbl-rpt">
                            <tr class="RptHeader">
                                <td style="width: 20px;">
                                    #
                            ...
                            <tr class="{classname} c bg_white nobold">
                                <td colspan="6">
