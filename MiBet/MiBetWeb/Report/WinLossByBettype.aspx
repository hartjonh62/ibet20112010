...
<body>
    ...
    <div id="page_main">
        <div id="header_main">
            ...
            <asp:Label ID="lblTitle" runat="server" Text="Win Loss By Bet Type"></asp:Label>
        </div>
...
&nbsp;</td>
            ...
            <tr>
                <td>
                    <div id="divContent">
                        <table class="tblRpt nowrap boldrow r" width="750" border="0" cellpadding="0" cellspacing="1"
                            id="tbl-rpt">
                            <tr id="rowTitle" class="RptTitle">
                                <td colspan="20" id="spTitle">
                                    Win Loss By Bet Type 
...
&nbsp;--&gt;
                <asp:Label ID="lblTDate" runat="server"></asp:Label>
                            ...
                            <tr class="RptHeader">
                                ...
                                <td rowspan="2" class="nowrap" style="width: 80px">
                                    Gross Comm
                                </td>
                                <td rowspan="2">
                                    Agent Total
