<%@ Page Language="C#" AutoEventWireup="true" Inherits="Report_CommissionByBettype" Codebehind="CommissionByBettype.aspx.cs" %>
...
<body>
    ...
    <input
                                            type="hidden" name="type" id="type" value="master" />
    ...
    <div id="page_main">
        <div id="header_main">
            ...
            <asp:Label ID="lblTitle" runat="server" Text="Commission By Bet Type"></asp:Label>
        </div>
