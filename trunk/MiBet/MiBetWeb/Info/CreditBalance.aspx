...
<body>
<div id="page_main"><div id="header_main">Balance</div><div id="sContent"><table width="420" border="0" cellpadding="0" cellspacing="1" class="tblRpt"><tr><td colspan="2" class="RptHeader">Master Balance Information:&nbsp; SMQQ</td></tr><tr class="bg_eb"><td>Cash Balance</td><td class="l"><font class="positive">Yen 0.00</font></td></tr ><tr class="bg_eb"><td>Yesterday Cash Balance</td><td class="l"><font class="positive">Yen 0.00</font></td></tr><tr class="bg_eb"><td>Total Balance</td><td class="l"><font class="positive">Yen 0.00</font></td></tr class="bg_eb"><tr class="bg_eb"><td>Yesterday Total Balance</td><td class="l"><font class="positive">Yen 0.00</font></td></tr><tr class="bg_eb"><td>Master Outstanding</td><td class="l"><font class="positive">Yen 0.00</font></td></tr><tr class="bg_eb"><td>Total Outstanding</td><td class="l"><font class="positive">Yen 0.00</font></td></tr><tr class="bg_eb"><td>Master Credit</td><td class="l"><font class="positive">Yen 0.00</font></td></tr><tr class="bg_eb"><td>Total Agent Credit</td><td class="l"><font class="positive">Yen 0.00</font></td></tr><tr class="bg_eb"><td>Total Member Credit</td><td class="l"><font class="positive">Yen 0.00</font></td></tr><tr class="bg_eb"><td>Total Agent active/closed/suspended</td><td class="b l"><font color="#003366">2</font>/<font color="#d12320">0</font>/<font color="#d45f12">0</font></td></tr><tr class="bg_eb"><td>Total Member active/closed/suspended</td><td class="b l"><font color="#003366">1</font>/<font color="#d12320">0</font>/<font color="#d45f12">0</font></td></tr></table></div><style type="text/css">.cssNoel{position:absolute;float:right;bottom:1px;z-index:1;right:1px;}</style><script>function showFlashNoel(canDisplay, divContentId) {if (canDisplay == 'True') {if (!hasCookieName(divContentId, 2012567, 0)) {showDivPopup(divContentId);setFlashCookie('flashLaterNoel', true, 2012567, 0);;return 1;}}return 0;}window.onload = function Loaded() {showFlashNoel('True', 'flashLaterNoel');}</script>
