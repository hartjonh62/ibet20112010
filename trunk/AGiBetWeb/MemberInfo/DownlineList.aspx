                                ...
                                <table class="l" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td id="tdfdatetext" style="padding-top: 6px" class="l">
                                            <span>&nbsp;</span><asp:Label ID="lblUserName" runat="server" Text="User Name:"></asp:Label>
&nbsp;</td>
                                        <td id="tdfdatetext" style="padding-top: 6px" class="l">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-top: 6px; padding-bottom: 6px;">
                                            <asp:DropDownList ID="ddlStatusFilter" runat="server"  
                                                style="width: 80px; font-size: 8pt; font-weight: normal;">
                                ...
                                <table class="tblRpt r nowrap" cellpadding="0" cellspacing="1" style="width: 100%;"
                                    ...
                                    <tbody>
                                        ...
                                        foreach (AGiBetCommon.MemberInformation.clsAccount item in objBAcount.getAll())
                                        {
                                            ...
                                            {
                                                count++;
                                                AGiBetCommon.MemberInformation.clsUserCommission objUserCommission = new AGiBetCommon.MemberInformation.clsUserCommission();
                                                objUserCommission = objBUserCommission.getByAccId(item.Id);
                                     ...
                                     %>
                                        <tr align="center" bgcolor="#F6F8F9" onmouseover="bgColor='#f8ff8d'" onmouseout="bgColor='#F6F8F9'">
                                            ...
                                            <td>
                                            <input type="checkbox" id="Checkbox1"  onclick="chkChecked(this);" name="chkid" value="<%=item.Id%>;<%=item.UserName%>" statuscs="0" />
                                            ...
                                            <td>
                                                ...
                                                <div class="divEdit" title="Edit" style="cursor: pointer;" onclick="showReset('<%=item.Id  %>','<%=item.UserName %>');" />
                                            </td>
                                            <td class="l">
                                                <%=item.NickName%>
                                            </td>
                                            ...
                                            <td>
                                                <%=objUserCommission.CommA%>
                                            </td>
                                            <td>
                                                 <%=objUserCommission.CommB%>
                                            </td>
                                            <td>
                                                 <%=objUserCommission.CommC%>
                                            </td>
                                            <td>
                                                 <%=objUserCommission.CommD%>
                                            </td>
                                            <td>
                                                <%=objUserCommission.Comm1x2%>
                                            </td>
                                            <td>
                                                 <%=objUserCommission.CommOther%>
                                            </td>
                                            <td class="bl_time">
