...
<body>
    ...
    <div id="page_main">
        <div id="header_main">
            <asp:Label ID="lblSubAccount" runat="server" Text="Sub Account"></asp:Label>
            &nbsp;
            <asp:Button ID="tbnAddSubAccount" runat="server" Text="Add Sub Account" OnClientClick="AddNewSubAcc();"
                class="btn" />
            <tr>
                <td class="emsg_1_1">
                    &nbsp;
            ...
            <table width="900px" class="tblRpt" cellspacing="1" cellpadding="0" border="0">
                ...
                <tr align="center" bgcolor="#faf9ee" onmouseover="bgColor='#f8ff8d'" onmouseout="bgColor='#faf9ee'">
                    ...
                    <td class="l">
                        <asp:Label ID="lblSMQQ02Sub01" runat="server" Text="SMQQ02Sub01"></asp:Label>
                    </td>
                    <td class="l">
                    </td>
                    <td class="l">
                    ...
                    <td class="bl_time">
                        1/3/2010 12:15:44 AM
                    </td>
                    <td>
                        <asp:CheckBox ID="chkD114369" runat="server" Checked onclick="GetInfoSubAcc(114369,this,'D');" />
                    </td>
                    <td>
                        <asp:CheckBox ID="chkE114369" runat="server" Checked onclick="GetInfoSubAcc(114369,this,'E');" />
                    </td>
                    <td>
                        <asp:CheckBox ID="chkA114369" runat="server" Checked onclick="GetInfoSubAcc(114369,this,'A');" />
                    </td>
                    <td>
                        <asp:CheckBox ID="ckhB114369" runat="server" Checked onclick="GetInfoSubAcc(114369,this,'A');" />
                    </td>
                    <td>
                        <asp:CheckBox ID="chkC114369" runat="server" Checked onclick="GetInfoSubAcc(114369,this,'C');" />
                        &nbsp;</td>
                    <td align="center">
                        <div class="divEdit" title="Edit" onclick="EditSubAcc(114369, 'SMQQ02Sub01', 'yes');">
                        </div>
                    </td>
                    <td>
                        <div class="divEdit" title="Edit" onclick="EditSubAcc(114369,'SMQQ02Sub01', 'no');">
                        </div>
                    </td>
                </tr>
            </table>
