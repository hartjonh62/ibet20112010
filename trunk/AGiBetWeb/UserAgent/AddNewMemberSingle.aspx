<%@ Page Language="C#" AutoEventWireup="true" Inherits="UserAgent_AddNewMemberSingle"
    CodeBehind="AddNewMemberSingle.aspx.cs" EnableEventValidation="false" %>
        ...
        <div class="sptPT" style="width: 750px;">
            ...
            <table class="tblRpt" width="100%" border="1">
                ...
                <tr class="bg_eb">
                    ...
                    <td class="l">
                        <asp:TextBox ID="txtComHdp" runat="server" ReadOnly="true" Style="width: 70px;"></asp:TextBox>
                    ...
                    <td class="l">
                        <asp:TextBox ID="txtCommForAgent" runat="server" ReadOnly="true" value="0.01" Style="width: 70px;"></asp:TextBox>
                    </td>
                </tr>
                <tr class="bg_eb">
                    <td class="r">
                ...
                <tr class="bg_eb">
                    ...
                    <td class="l">
                        <asp:TextBox ID="txtDiscount1x2" runat="server" ReadOnly="true" value="0.0025" Style="width: 70px;"></asp:TextBox>
                    </td>
                    ...
                    <div class="b_add">
                        <li>
                            <asp:LinkButton ID="LinkAdd" runat="server" 
                                OnClientClick="return BtnOnClick();" onclick="LinkAdd_Click"><span>Add</span></asp:LinkButton>
                        </li>
                    </div>
                </td>
            </tr>
