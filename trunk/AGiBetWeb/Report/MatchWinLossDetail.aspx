...
Now, gross commission = (your commission percentage) * turnover (excluding Draw tickets).</font></li></ul></div></div></td></tr><tr><td><div id="tbl-container"><div id="boderRight"><table class="tblRpt r nowrap boldrow" cellpadding="0" cellspacing="1" style="width: 100%;" id="tbl-rpt"><thead><tr id="rowTitle" class="RptTitle l"><td id="spTitle" colspan="11">Match Win Loss Detail 01/02/2010 --> 01/02/2010</td></tr><tr><td class="RptHeader" colspan="3">
            &nbsp;</td><td class="RptHeader" colspan="3">Member</td><td class="RptHeader" colspan="3">Agent</td><td class="RptHeader" colspan="2">Company</td></tr><tr><td class="RptHeader02">Bet Type</td><td class="RptHeader02">Turnover</td><td class="RptHeader02">Gross Comm</td><td class="RptHeader02">Win/Loss</td><td class="RptHeader02">Comm</td><td class="RptHeader02">Total</td><td class="RptHeader02">Win/Loss</td><td class="RptHeader02">Comm</td><td class="RptHeader02">Total</td><td class="RptHeader02">Comm</td><td class="RptHeader02">Total</td></tr></thead><tbody><tr class="bg_white c"><td colspan="11" class="nobold">No information is available</td></tr></tbody></table></div></div></td></tr></table><input type="hidden" id="rowcount" name="rowcount" value="0" /><input type="hidden" id="columncount" name="columncount" value="11" /></div>
</form>
