...
<body>
    ...
    <div id="page_main"><div id="header_main"><div class="divBoxRight"><asp:CheckBox ID="chkBold" checked="true" runat="server" onclick="boldTable(this.checked);"/><span style="color:#999; text-transform:none">Bold</span>&nbsp;<input type="image" id="exporttoexcel" name="exporttoexcel" alt="Export to Excel" noFocus="true" src="../App_Themes/AgencyV2/Images/excel.gif" title="Export to Excel" class="hand" /></div>
            ...
            &nbsp;&nbsp; <span id="sptdatetext">To:</span></td><td id="tdToDateCal" class="l"><span id="spToDateCal"><table cellpading="0" cellspacing="0" border="0"><tr><td>
                                                    ...
                                                    </td></tr></table></span></div></td></tr><tr><td><div id="divContent"><table class="tblRpt boldrow r" width="100%" border="0" cellpadding="0" cellspacing="1" id="tbl-rpt"><tr id="rowTitle" class="RptTitle"><td colspan="6" id="spTitle">
                Horse Racing Commission 01/02/2010 --&gt; 01/02/2010<input type="hidden" name="custid" id="custid" value="2050492" /><input type="hidden" name="isdate" id="isdate"/><input type="hidden" name="type" id="type" value=""/></td></tr><tr class="RptHeader"><td rowspan="2">
                    User Name</td><td colspan="4">Tote</td><td rowspan="2">Total</td></tr><tr class="RptHeader02"><td style="width:60px;">
                Win</td><td style="width:60px;">Place</td><td style="width:60px;">Win Place</td><td style="width:60px;">
                Total</td></tr><tr class="bg_white c"><td colspan="6" class="nobold">No information 
                    is available</td></tr></table></div></td></tr></table><input type="hidden" value="{cus}" name="hdcus" id="hdcus" /><input type="hidden" value="{role}" name="hdrole" id="hdrole" /><input type="hidden" value="{site}" name="hdsite" id="hdsite" /><input type="hidden" value="{checked_SB}" name="hdSB" id="hdSB" /><input type="hidden" value="{checked_Casino}" name="hdCasino" id="hdCasino" /><input type="hidden" value="{checked_HR}" name="hdHR" id="hdHR" /><input type="hidden" value="{checked_FI}" name="hdFI" id="hdFI" /></div>
</form>
