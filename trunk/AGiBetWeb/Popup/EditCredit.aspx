<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditCredit.aspx.cs" Inherits="AGiBetWeb.Popup.EditCredit" %>
            ...
            <tr>
                <td>
                    <table width="100%" align="left" class="tblPop" cellspacing="1" cellpadding="0" border="0">
                        <tr class="bg_eb2">
                            <td class="r b" width="45%">
                                <asp:Label ID="lblPassword" runat="server" Text="Credit"></asp:Label>
                            </td>
                            <td class="l">
                        ...
                        <tr class="bg_eb2">
                            ...
                            <td class="l">
                                <asp:Button ID="btnUpdate" runat="server" 
                                    Text="Submit" class="btn" onclick="btnUpdate_Click" />
                        &nbsp;
                                <asp:Button ID="btnUpdate0" runat="server" 
