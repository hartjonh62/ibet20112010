<%@ Page Language="C#" AutoEventWireup="true" Inherits="TotalBets_Horseracing" CodeBehind="Horseracing.aspx.cs" %>
...
<body>
    <div id="page_main">
        <div id="header_main">
            <asp:Label ID="lblHorseRacing" runat="server" Text="Horse Racing"></asp:Label></div>
        <div id="sContent">
            <table class="tblRpt" cellpading="0" cellspacing="1" border="0" style="width: 860px;">
                <tr class="RptHeader">
                    <td rowspan="3" style="width: 7%;">
                        Race
                    </td>
                    <td rowspan="3" style="width: 6%;" class="nowrap">
                        Horse No
                    </td>
                ...
                <tr>
                    <td colspan="15" class="bg_white c nobold">
