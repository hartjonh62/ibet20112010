<%@ Page Language="C#" AutoEventWireup="true" Inherits="ForeCast_MasterForecast"
    CodeBehind="MasterForecast.aspx.cs" %>
                                        ...
                                        <tr>
                                            ...
                                            <td id="selLeague" width="300">
                                                <asp:DropDownList ID="ddlLeague" runat="server" onchange='SelectedLeague();'>
                                                    ...
                                                    <asp:ListItem>TURKEY SUPER LEAGUE</asp:ListItem>
                                                    ...
                                                    <asp:ListItem>Italy Lega Pro 1B</asp:ListItem>
                                                    ...
                                                    <asp:ListItem>PQatar League</asp:ListItem>
                ...
                <td>
                    <div id="divContent">
                        <table class="tblRpt" cellpadding="0" cellspacing="1" border="0" style="width: 600px">
                            ...
                            <tr align="center">
                                <td class="l pad73 league" colspan="8" style="padding-left: 20px;">
                                    <asp:Label ID="lbl2" runat="server" Text="Everton-vs-Birmingham City"></asp:Label>
                                </td>
                            </tr>
                            <tr class="even_row" align="center">
                                <td colspan="2" class="informal" style="height: 20px">
                            ...
                            <tr align="center">
                                <td class="l pad73 league" colspan="8" style="padding-left: 20px;">
                                    <asp:Label ID="lbl3" runat="server" Text="West Ham United-vs-Chelsea"></asp:Label>
                                </td>
                            </tr>
                            <tr class="even_row" align="center">
                                <td colspan="2" class="informal" style="height: 20px">
