<%@ Page Language="C#" AutoEventWireup="true" Inherits="UserAgent_AddNewMemberSingle"
    CodeBehind="AddNewMemberSingle.aspx.cs" EnableEventValidation="true" %>
...
<head>
    ...
    {
        $("txtComHdp").value = $("slGroup").value;
        changeComm($("slGroup").value, "slComHdp");
        $("hdGroup").value = $("slGroup").options[$("slGroup").selectedIndex].text;
    }
    ...
    function CopyHandicap()
    {
        ...
        {
            $("slOtherPT").disabled = true;
            $("slOutrightPT").disabled = true;
            $("slLivePT").disabled = true;
        }
        else
        {
            $("slOtherPT").disabled = false;
            $("slOutrightPT").disabled = false;
            $("slLivePT").disabled = false;
        }
    }
...
<body>
    ...
    <div id="page_main">
        <div id="header_main">
            <asp:Label ID="lblAddNew" runat="server" Text="Add New Member"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnFullMode" runat="server" Text="Full Mode" class="btn" Style="font-size: 8pt;"
                OnClientClick="location.href='AddNewMember.aspx';" />
        </div>
            ...
            <table class="tblRpt" width="100%" border="1">
                <tr class="bg_eb">
                    ...
                    <td class="l" style="width: 30%;">
                        SMQQ02
                        <asp:DropDownList ID="dllNumber1" runat="server">
                        ...
                        <asp:DropDownList ID="dllNumber3" runat="server">
                    ...
                    <td class="l" style="width: 30%;" id="td_pass">
                        <asp:TextBox ID="txtPass" runat="server" onkeyup="return checkpass(this);"></asp:TextBox>
                    </td>
                </tr>
                <tr class="bg_eb">
                    <td class="r">
            ...
            <table class="tblRpt" width="100%" border="1">
                ...
                <tr class="bg_eb">
                    ...
                    <td class="l">
                        ...
                        <a class="imaLink img" href="javascript:ReducePT('slPT',1)">
                            <img class="hand" hspace="1" id="btnReduce1" name="btnReduce1" src="../App_Themes/AgencyV2/Images/b_down.jpg" /></a><a
                                class="imaLink img" href="javascript:IncreasePT('slPT',1)"><img class="hand" hspace="1"
                                    id="btnIncrease1" name="btnIncrease1" src="../App_Themes/AgencyV2/Images/b_up.jpg" /></a><a
                                        class="imaLink img" href="javascript:ReducePT('slPT',10)"><img class="hand" hspace="1"
                                            id="btnReduce10" name="btnReduce10" src="../App_Themes/AgencyV2/Images/b_sub.jpg" /></a><a
                                                class="imaLink img" href="javascript:IncreasePT('slPT',10)"><img class="hand" hspace="1"
                                                    id="btnIncrease10" name="btnIncrease10" src="../App_Themes/AgencyV2/Images/b_add.jpg" /></a>
        ...
        <div style="margin-top: -7px; margin-bottom: -7px" class="warning">
            <ul>
                ...
                <li>In case you need to customize different settings for different sports, please use
                    the <a href="AddNewMember.aspx">Full Mode.</a>
            </ul>
        </div>
        <table cellspacing="0" cellpadding="0" align="left" border="0" id="tblBtn">
            <tr>
                <td class="l" valign="top">
                    <div class="b_add">
                        <li>
                            <asp:LinkButton ID="LinkAdd" runat="server" OnClientClick="BtnOnClick();"><span>Add</span></asp:LinkButton>
                        </li>
                    </div>
                </td>
            </tr>
            ...
            id="hdMaxBet" name="hdMaxBet" value="35,000" /><input type="hidden" id="hdMaxPerMatch"
                name="hdMaxPerMatch" value="200,000" /><input type="hidden" id="hdMaxPerMatchMin"
                    name="hdMaxPerMatchMin" value="0" /><input type="hidden" id="hdMaxCredit" name="hdMaxCredit"
                        value="0" /><input type="hidden" id="hdDiscountcs" name="hdDiscountcs" value="{discountcs-value}" /><input
