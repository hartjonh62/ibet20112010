<%@ Page Language="C#" AutoEventWireup="true" Inherits="Report_WinLossDetailAgent"
    CodeBehind="WinLossDetailAgent.aspx.cs" %>
...
<body>
    ...
    <td id="tdFromDateCal" class="l">
        ...
        <asp:CheckBox ID="chk_SB" runat="server"  onclick="IsCheck()" checked="true"/>
                <label for="chk_SB">SB</label>&nbsp;&nbsp;&nbsp;&nbsp;<!--<input type="checkbox" id="chk_P2P" style="visibility: hidden" onclick="IsCheck()" />-->
           <asp:CheckBox ID="chk_HR" runat="server" onclick="IsCheck()" checked="true"/>
                    <label for="chk_HR">Horse</label>&nbsp;&nbsp;&nbsp;&nbsp;
