<%@ Page Language="C#" AutoEventWireup="true" Inherits="Report_CommissionByBettype"
    CodeBehind="CommissionByBettype.aspx.cs" %>
...
<body>
    ...
    <div id="page_main">
        <div id="header_main">
            <div class="divBoxRight"><asp:CheckBox ID="chkBold" checked="true" runat="server" onclick="boldTable(this.checked);"/>
                <span
            ...
            <asp:Label ID="Label1" runat="server" Text="Commission By Bet Type"></asp:Label></div>
                    ...
                    <div id="divContent">
                        <table class="tblRpt boldrow nowrap r" width="100%" border="0" cellpadding="0" cellspacing="1"
                            ...
                            <tr id="rowTitle" class="RptTitle">
                                <td colspan="22" id="spTitle">
                                    Commission By Bet Type 01/02/2010 --&gt 01/02/2010<input type="hidden" name="custid"
            ...
            value="{role}" name="hdrole" id="hdrole" /><input type="hidden" value="{site}" name="hdsite"
                id="hdsite" /><input type="hidden" value="{checked_SB}" name="hdSB" id="hdSB" /><input
                    type="hidden" value="{checked_Casino}" name="hdCasino" id="hdCasino" /><input type="hidden"
                        value="{checked_HR}" name="hdHR" id="hdHR" />
        <input type="hidden" value="{checked_FI}" name="hdFI" id="hdFI" />
    </div>
    </form>
</body>
</html>
