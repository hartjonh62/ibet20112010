        ...
        <div id="header_main" style="width: 97%">
            <div class="divBoxRight">
                <input type="image" id="exporttoexcel" name="exporttoexcel" alt="Export to Excel"
                    ...
                    class="hand" /></div>
            <asp:Label ID="lbl" runat="server" Text="Void/Rejected Bet List (Last 3 days)"></asp:Label></div>
            ...
            <tr>
                <td>
                    <span id="spData">
                        <form method="post">
                        <div id="">
                            <table id="tbl1" border="0" cellspacing="0" cellpadding="0" class="hidden" width="99%">
                                <tr>
                                    <td style="text-align: left; white-space: nowrap; width: 50%;">
                                        <div id="header_main" style="position: relative; left: -2px;">
                                            <b>Bet List {frmtodate}</b></div>
                                    </td>
                                    <td align="right" style="width: 45%;">
                                        <div style="display: none">
                                            <div style="text-align: right;">
                                                <input type="image" id="exporttoexcel" name="exporttoexcel" alt="{exporttoexcel}"
                                                    nofocus="true" src="../App_Themes/AgencyV2/Images/excel.gif" title="{exporttoexcel}"
                                                    class="hand" /></div>
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <table id="tbl2" border="0" cellpadding="0" cellspacing="1" style="display: none;
                                margin-bottom: 10px; width: 100%" class="tblRpt">
                                <tr class="RptHeader">
                                    <td style="width: 20px;">
                                        #
                                    </td>
